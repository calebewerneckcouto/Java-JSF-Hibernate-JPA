...
public class IDaoLancamentoImpl implements IDaoLancamento, Serializable {
	...
	@Override
	public List<Lancamento> relatorioLancamento(String topico, Date dataIni, Date dataFim) {
		...
		if (dataIni == null && dataFim == null && topico != null && !topico.isEmpty()) {
			sql.append(" where l.topico = '").append(topico.trim()).append("'");
			
		}else if (topico == null || (topico != null && topico.isEmpty()) 
			...
			sql.append(" where l.dataIni >= '").append(dataIniString).append("' ");
			sql.append(" and l.dataFin <= '").append(datafimString).append("' ");
			sql.append(" and l.topico = '").append(topico.trim()).append("'");
		}
